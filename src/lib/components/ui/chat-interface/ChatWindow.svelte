...
<div class="h-full flex flex-col">
	...
	<div class="flex flex-col h-full">
			...
			{#if messages.length === 0}
				<div class="flex items-center justify-center h-full">
					<div class="text-center max-w-md">
						<div
							class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4 mt-0"
						>
		...
		<div
			class="border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 p-4 sticky bottom-0 z-10"
		>
			{#if isProcessing}
				<div class="flex justify-center mb-2">
					<button
						type="button"
						class="text-xs text-muted-foreground hover:text-primary font-medium transition-colors"
			...
			<form on:submit|preventDefault={sendMessage} class="flex items-end gap-3">
				...
				<div class="flex-1 flex flex-col">
					{#if uploadedFile}
						<div
							class="mb-2 p-2 bg-muted/50 rounded-lg border border-border flex items-center justify-between"
						>
					...
					<div
						class="flex items-center gap-2 bg-muted/20 rounded-2xl p-2 border border-border/50 focus-within:border-primary/50 transition-colors"
					>
						<textarea
							...
							class="flex-1 bg-transparent border-0 outline-none resize-none max-h-[50px] text-sm leading-6 py-1"
							rows="1"
						...
						<button
							type="submit"
							class="p-2 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 flex items-center justify-center"
						>
							<Icon
