<div class="py-40">
	...
	>
		...
		>
			<h3 id="tier-hobby" class="text-base font-semibold text-[#2C7BE5]">Basic</h3>
  ...
  >
      Get started today
		...
		<div class="relative rounded-3xl bg-gray-900 p-8 shadow-2xl ring-1 ring-gray-900/10 sm:p-10">
			<h3 id="tier-enterprise" class="text-base/7 font-semibold text-[#2C7BE5]">Premium</h3>
			<p class="mt-4 flex items-baseline gap-x-2">
				<span class="text-5xl font-semibold tracking-tight text-white">$99</span>
				<span class="text-base text-gray-400">/monthly</span>
			</p>
