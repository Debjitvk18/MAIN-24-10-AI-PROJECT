<script lang="ts">
    ...
    import FacebookMarketplaceItem
        from "$lib/components/ui/map/social-cards/facebook-marketplace/FacebookMarketplaceItem.svelte";
    ...
    async function fetchFacebookMarketPlace(pageNumber = 1) {
        try {
            ...
            marketplaceData = res.response.flatMap((fbmResponse) =>
