		...
		<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
			<Card.Root>
				...
				>
					...
					<Icon icon="lucide:dollar-sign" class="text-muted-foreground h-4 w-4" />
				</Card.Header>
				<Card.Content>
			...
			<Card.Root>
				...
				>
					...
					<Icon class="text-muted-foreground h-4 w-4" icon="lucide:user" />
				</Card.Header>
				<Card.Content>
			...
			<Card.Root>
				...
				>
					...
					<Icon icon="lucide:credit-card" class="text-muted-foreground h-4 w-4" />
				</Card.Header>
				<Card.Content>
